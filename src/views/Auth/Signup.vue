<template>
  <div class="signin">
    <div class="signin__cover-image">
      <img src="../../assets/img/register.png" />
    </div>
    <div class="signin__description">
      <h2 class="heading-l">Qeydiyyat</h2>
      <p>
        Özün haqqında lazımi məlumatları daxil etdikdən sonra artıq sən də öz
        <span class="text-blue bold">TEAMMATE</span>-ni rahatlıqla tapa
        biləcəksən
      </p>
    </div>
    <main class="signin__main">
      <div class="input-group-gray-outlined">
      ...
      <div class="input-group-gray-outlined">
        <input placeholder="Şifrə" type="password" id="registrationPassword" />
        <img
      ...
      <div class="input-group-gray-outlined">
        ...
        <img
          src="../../assets/img/eye.png"
          v-if="passwordRepeatIsVisible"
          alt=""
          @click="changePasswordRepeatVisibility()"
        />
        <img
          src="../../assets/img/eye-off.png"
          v-if="!passwordRepeatIsVisible"
      ...
      <button class="button-blue-bg-rounded" @click="signupFunction()">
        Qeydiyyatdan keç
      </button>
    </main>
...
export default {
  ...
  methods: {
    ...
    changePasswordRepeatVisibility() {
      this.passwordRepeatIsVisible = !this.passwordRepeatIsVisible;
      let registrationPassword = document.getElementById(
